 ...
 * @param {boolean} shouldValueBeEqual The value "shouldValueBeEqual" to negate the check (cookie value should not match).
 */
module.exports = async function(cname, cvalue, shouldValueBeEqual) {
