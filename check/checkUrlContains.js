 ...
 * @param {String} not Expected url to check if the web page url contains.
 * @param {String} expectedUrl The string "not" to indicate the URL should not match the expected.
 */
